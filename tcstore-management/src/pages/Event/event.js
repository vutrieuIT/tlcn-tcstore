...
const Home = () => {
      ...
      await eventApi.deleteEvent(id).then((response) => {
        if (response === undefined) {
          notification["error"]({
            ...
            description: "Delete event failed",
          });
        } else {
  ...
  const handleRejectEvent = async (values) => {
    try {
      ...
      await axiosClient
        .patch("/event/" + idReject + "/cancel_event", formatData)
        .then((response) => {
          if (response === undefined) {
            notification["error"]({
              message: `Notification`,
            ...
            notification["success"]({
              message: `Notification`,
              description: "Successfully Reject Event",
            });
                      ...
                      <Card bordered={false} style={{ borderRadius: 6 }}>
                        <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                          ...
                          <Col style={{ paddingRight: 0 }} span={7}>
                            ...
                            >
                              {eventDetail.createdBy?.firstName ? (
                                <UserOutlined />
                              ) : (
                                <HomeOutlined />
                              )}
                          ...
                          >
                            <p
                              ...
                              className="event_container__fixLine"
                            ...
                            <div className="event__button-wrap">
                              <Row justify="center">
                                <Button
                                  ...
                                  icon={<EyeOutlined />}
                                  onClick={() =>
                                    handleDetaisView(eventDetail.uid)
                                  }
                                >
                                  {"View"}
                                </Button>
                                ...
                                {checkAuth() === "creator" ? (
                                  <Popconfirm
                                    ...
                                    onConfirm={() =>
                                      handleDeleteEvent(eventDetail.uid)
                                    }
                                    okText="Yes"
                                    cancelText="No"
                                  >
                      ...
                      <Card bordered={false} style={{ borderRadius: 6 }}>
                        <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                          ...
                          <Col style={{ paddingRight: 0 }} span={7}>
                            ...
                            >
                              <TeamOutlined /> Number Of Attendance:{" "}
                              <Tag color="blue">
                                {eventDetail.count_join_event}/
                                {eventDetail.size}
                              </Tag>
