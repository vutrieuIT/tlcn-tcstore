                                    ...
                                    <Badge.Ribbon text="Giảm giá" color="red" >
                                        <Card className="card_product" onClick={() => handleReadMore(item._id)}>
                                            ...
                                            <div className="support_product">
                                                Thu cũ máy cũ - Giá thu cao nhất - Tặng thêm 1 triệu khi đổi máy cũ
                                            </div>
                    ...
                    <OverPack style={{ overflow: 'hidden', height: 800, marginTop: 20 }} >
                        ...
                        >
                            ...
                            <div className="texty-title-footer">
                                <p>Tham Dự Buổi <strong>Ra Mắt Galaxy S24</strong></p>
                                <p style={{ fontSize: '18px', fontStyle: 'italic', marginTop: '-2em' }}>Vào ngày 17/1/2024 - tại San Francisco, Mỹ.</p>

                            </div>
                            <Row justify="center" style={{ marginBottom: 100, fill: "#FFFFFF" }}>
